...
fn test_get_node_and_get_node_mut() {
    ...
    let node_id = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
...
fn test_add_edge_with_validation() {
    ...
    let source_id = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let target_id = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    
    let props = PropertyMap::new().with("line", 42i64);
    let edge_id = graph.add_edge(source_id, target_id, EdgeType::Calls, props).unwrap();
...
fn test_get_neighbors_outgoing() {
    ...
    let source = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let target1 = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let target2 = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    
    graph.add_edge(source, target1, EdgeType::Calls, PropertyMap::new()).unwrap();
    graph.add_edge(source, target2, EdgeType::Calls, PropertyMap::new()).unwrap();
...
fn test_get_neighbors_incoming() {
    ...
    let target = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let source1 = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let source2 = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    
    graph.add_edge(source1, target, EdgeType::Calls, PropertyMap::new()).unwrap();
    graph.add_edge(source2, target, EdgeType::Calls, PropertyMap::new()).unwrap();
...
fn test_get_neighbors_both_directions() {
    ...
    let node_a = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let node_b = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    let node_c = graph.add_node(NodeType::Function, PropertyMap::new()).unwrap();
    
    graph.add_edge(node_a, node_b, EdgeType::Calls, PropertyMap::new()).unwrap();
    graph.add_edge(node_c, node_a, EdgeType::Calls, PropertyMap::new()).unwrap();
...
fn test_delete_node_cascades_to_edges() {
    ...
    let edge1 = graph.add_edge(node_a, node_b, EdgeType::Calls, PropertyMap::new()).unwrap();
    let edge2 = graph.add_edge(node_c, node_a, EdgeType::Calls, PropertyMap::new()).unwrap();
