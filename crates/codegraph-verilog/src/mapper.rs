...
pub fn ir_to_graph(
    ...
    // Add Verilog modules as class nodes
    ...
    // Add functions (Verilog functions and tasks)
    for func in &ir.functions {
        ...
        // Link function to its parent module or file
    ...
    // Add import relationships (includes and package imports)
    ...
    // Add call relationships (module instantiations)
