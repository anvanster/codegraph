//! Implementation of the CodeParser trait for Java
...
/// Java language parser implementing the CodeParser trait
...
mod tests {
    ...
    fn test_can_parse() {
        ...
        assert!(parser.can_parse(Path::new("src/com/example/App.java")));
