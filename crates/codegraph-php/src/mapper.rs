...
pub fn ir_to_graph(
    ...
    // Add implementation relationships (class implements interface, uses trait)
...
mod tests {
    ...
    fn test_ir_to_graph_empty() {
        let ir = CodeIR::new(PathBuf::from("test.php"));
    ...
    fn test_ir_to_graph_with_imports() {
        let mut ir = CodeIR::new(PathBuf::from("test.php"));
        ir.add_import(ImportRelation::new("main", "App\\Models\\User"));
        ir.add_import(ImportRelation::new("main", "App\\Services\\Auth"));
    ...
    fn test_ir_to_graph_function_properties() {
        ...
        let func = FunctionEntity::new("publicFunc", 1, 5)
            ...
            .with_signature("public function publicFunc(): string");
